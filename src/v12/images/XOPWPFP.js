...
class XOPWPFP {
    constructor(options = {}) {
        ...
        if (!options.embed.title) options.embed.title = "AD Image";
    ...
    async startFunction() {
        if (this.mention === false) {
            ...
            const embed = new MessageEmbed()
                ...
                .setImage(`https://vacefron.nl/api/wide?user=${avatar}`)
                .setTimestamp()
                .setFooter("XOPPACK©️ | Powered By VaceFron", this.message.author.displayAvatarURL({ dynamic: true }))
