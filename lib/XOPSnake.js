...
class XOPSnakeGame {
    ...
    move(msg) {
        ...
        let embed2 = new MessageEmbed().setTimestamp().setColor(emb.color).setAuthor("Snake", this.message.author.displayAvatarURL({ dynamic: true })).setDescription(`**Score:**\`${this.score}\`\n\n${this.getGameBoard()}`).setFooter('XOPPACK©', this.message.author.displayAvatarURL({ dynamic: true }))
    ...
    async gameOver(msg) {
        ...
        const editEmbed = new MessageEmbed().setTimestamp().setColor(emb.color).setAuthor("Snake", this.message.author.displayAvatarURL({ dynamic: true })).setDescription(`**Score:**\`${this.score}\`\n**${over}**\n\n${this.getGameBoard()}`).setFooter('XOPPACK©', this.message.author.displayAvatarURL({ dynamic: true }))
