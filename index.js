...
module.exports = {
    bent: function(str) {
        ...
        for (let a, d = 0, e = str.length; d < e; d++) {
            (a = bent[str.charAt(d)]), typeof a == 'undefined' && (a = str.charAt(d)), (c += a);
        }
        return c;
    },
    flip: function(str) {
        const c = [];
        for (let a, d = 0, e = str.length; d < e; d++) {
            (a = str.charAt(d)), d > 0 && (a == '\u0324' || a == '\u0317' || a == '\u0316' || a == '\u032e') ? ((a = flip[str.charAt(d - 1) + a]), c.pop()) : ((a = flip[a]), typeof a == 'undefined' && (a = str.charAt(d))), c.push(a);
        }
    ...
    mirror: function(str) {
        ...
        for (let a, e = 0, f = str.length; e < f; e++) {
            (a = str.charAt(e)), e > 0 && (a == '\u0308' || a == '\u0300' || a == '\u0301' || a == '\u0302') ? ((a = copy[str.charAt(e - 1) + a]), c.pop()) : ((a = copy[a]), typeof a == 'undefined' && (a = str.charAt(e))), a == '\n' ? (d.push(c.reverse().join('')), (c = [])) : c.push(a);
        }
    ...
    randomCase: function(string) {
        let result = '';
        if (!string) throw new TypeError('Invalid_String: A String Was Not Specified!');
        if (typeof string !== 'string') { throw new TypeError('Invalid_String: Provided String Is Invalid!'); }
    ...
    randomizeNumber: function(start, end) {
        ...
        if (typeof start !== 'number' && typeof end !== 'number') { throw new TypeError('Error: Provided number data is Invalid'); }
    ...
    reverseText: function(string) { return string.split('').reverse().join(''); },
    tinyCaptial: function(str) {
        let c = '',
            a;
        str = str.toUpperCase();
        for (let d = 0, e = str.length; d < e; d++) {
            (a = tiny[str.charAt(d)]), typeof a == 'undefined' && (a = str.charAt(d)), (c += a);
        }
        return c;
    },
